...
abstract class AppLocalizations {
  ...
  /// Subtitle under characters title
  ///
  /// In en, this message translates to:
  /// **'Rick & Morty Universe'**
  String get rickAndMortyUniverse;
  ...
  /// Empty state message on favourites screen
  ///
  /// In en, this message translates to:
  ...
  /// Button label to add character to favourites
  ///
  /// In en, this message translates to:
  /// **'Add to Favourites'**
  String get addToFavourites;

  /// Button label to remove character from favourites
  ///
  /// In en, this message translates to:
  ...
  String get yourSavedCharacters;
}
